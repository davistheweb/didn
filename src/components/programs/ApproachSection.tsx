...
export const ApproachSection: React.FC = () => {
  return (
    <section className="flex w-full flex-col gap-5 px-8 py-15 lg:py-20">
      <div data-aos="fade-up">
        <Headline
          heading="05 / Our Approach"
      ...
      >
        ...
        >
          Sustainable development should be community-driven.
        </p>
        <p
          className={`${poppinsFont.className} max-w-2xl text-sm leading-relaxed text-gray-500`}
        >
          We bring communities, partners, institutions, and other stakeholders
          together to understand challenges, develop practical solutions, and
      ...
      <div className="relative mt-10 w-full">
        ...
        <div className="grid gap-10 md:grid-cols-4 md:gap-6 lg:gap-10">
          {approachStages.map((stage, stageIndex) => (
            <div
              key={stage.title}
              className="relative flex gap-5 md:flex-col md:gap-5"
              data-aos="fade-up"
              data-aos-delay={stageIndex * 100}
            >
              <span
